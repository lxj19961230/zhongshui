...
//              ByteBuffer buf = ByteBuffer.allocate(DEFAULT_BUF_SIZE);
     ...
     * @param override
     *            - override the source or not.
     * @throws FileAlreadyExistsException
     *             if override is set to false and the target file exists but cannot be replaced.
     * @throws IOException
     *             if an I/O error occurs.
     * @since 1.0.6
     */
